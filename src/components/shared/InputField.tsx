    ...
    >
      <div className="w-full relative group">
        <input
          {...props}
          id={id}
          defaultValue={'12-02-2023'} // Set your desired default date value here
          value={inputValue}
          onChange={handleInputChange}
          className={`w-full bg-transparent outline-none focus:outline-none focus:ring-0 border-none text-[1rem] p-0 pt-[0.25rem] leading-[1.5rem] text-[#fff] placeholder:text-[#fff] peer group-focus-within:translate-y-[10%] ${
            inputValue.length > 0 && "translate-y-[10%]"
  ...
  return (
    ...
    >
      <div className="w-full relative group flex-1">
        ...
        <label
          htmlFor={id}
          className={`transform transition-all absolute top-0 left-0 h-full flex items-start text-[1rem] group-focus-within:text-[0.8125rem] font-[500] text-[#A0A0A0]  group-focus-within:h-1/2  ${
            rows > 5
              ? "group-focus-within:translate-y-[0%]"
              : "group-focus-within:translate-y-[5%]"
...
export { InputField, PasswordField, TextAreaField, DateField };
