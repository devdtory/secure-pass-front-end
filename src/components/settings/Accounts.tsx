              ...
              <div className="flex justify-end items-center h-full gap-x-[16px]">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex   justify-between text-[16px] bg-[#252525] rounded-[5px] items-center focus:outline-none relative w-[200px] px-[24px] py-[10px]">
                      English
                      <Image
                        alt="sort"
          ...
          <RowItem
            ...
            rightContent={
              <div className="flex justify-end items-center h-full gap-x-[16px]">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex   justify-between text-[16px] bg-[#252525] rounded-[5px] items-center focus:outline-none relative w-[400px] px-[24px] py-[10px]">
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="bg-[#252525] w-[400px] border-none rounded-[5px] text-[14px] text-[#EFEFEF]"
                  >
                    <DropdownMenuItem className="hover:bg-[#3A3A3A]/50 px-[24px] py-[10px]">
                      (-05:00) Eastern time (US & Canada)
                    </DropdownMenuItem>
